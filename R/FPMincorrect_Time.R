#' FPMincorrect_Time: Estimates the elapse time using the First Principles Model as written in the uncorrected Thomas et al., (2017) paper.
#'
#' This function estimates the elapsed time since start of a meal for a given cumulative intake
#' using the First Principles Model for the cumulative intake curves from Thomas et al., (2017), with the incorrect formula from the uncorrected paper.
#'
...
#'
#' @export
FPMincorrect_Time <- function(intake, parameters, Emax, message = TRUE) {
