...
#' @inheritParams Kissileff_n2ll
#' @inheritParams Kissileff_n2ll
#' @param hessian (optional) A logical indicator for using the hessian matrix to calculate standard errors of recovered parameter estimates. Default is FALSE.
#'
