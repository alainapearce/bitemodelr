#' expBites_Fogel2017 simulated bite data from an exponential decay distribution
#'
#' Simulated data based on Fogel et al., 2017 child microstructure behavior means and variance structure. 500 sets of mictrostructure behaviors were randomly selected from a multivariate normal distribution. Bites were generated using randomly selected bite timings using a exponential decay distribution. See generation script DataGen_SimDat_Fogel2017.R in raw-data.
#'
#'@references
...
#'
#' @examples
#' data(expBites_Fogel2017)
#' nBites <- attr(expBites_Fogel2017, "Bites")
#'
"expBites_Fogel2017"
