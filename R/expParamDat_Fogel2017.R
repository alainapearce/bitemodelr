#' expParamDat_Fogel2017 simulated parameter data from an exponential decay distribution
#'
#' Simulated data based on Fogel et al., 2017 child microstructure behavior means and variance structure. 500 sets of mictrostructure behaviors were randomly selected from a multivariate normal distribution. Model parameters were estimated after bites were generated using randomly selected bite timings using an exponential decay distribution. See generation script DataGen_SimDat_Fogel2017.R in raw-data.
#'
#'@references
...
#' @docType data
#'
#' @usage data(expParamDat_Fogel2017)
#'
...
#'
#' @examples
#' data(expParamDat_Fogel2017)
#' nBites <- attr(expParamDat_Fogel2017, "nBites")
#'
"expParamDat_Fogel2017"
