#' simBites_paramCheck: checks the feasibility of parameters recovered from simulated bite data
#'
#' This function checks the feasibility parameters recovered from simulated bite data for the Quadratic and Logistic Ordinary Differential Equation (LODE) model. For the Quadratic model, it checks the vertices relative to the sign of the quadratic coefficient and total intake. For the LODE model, it checks the r limit.
#'
...
#' @export
#'
simBites_paramCheck <- function(Emax, parameters, model_str = 'LODE', id) {
